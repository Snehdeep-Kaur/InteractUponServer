...
public class ServerControl extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Turn On Server");
        ...
        jButton1.setBounds(920, 510, 270, 80);

        statuslb.setIcon(new javax.swing.ImageIcon(getClass().getResource("/backgrounds/ServerControl.jpg"))); // NOI18N
        getContentPane().add(statuslb);
        statuslb.setBounds(0, 0, 1280, 720);
